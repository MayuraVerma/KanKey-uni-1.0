...
static int WINDOWS_NT_SERVER = FALSE;
...
void pushBackspaces()
{
          ...
          do
          {
                    ...
                    {
                              ::PostMessageW(hWnd,WM_KEYDOWN,(WPARAM)VK_BACK,(LPARAM)((0x0e<<16)|1));
                              ::PostMessageW(hWnd,WM_KEYUP,(WPARAM)VK_BACK,(LPARAM)((0x0e<<16)|1|(1<<31)));
...
void pushKeys()
{
          ...
          while(g_keystoadd.size()>0)
          {
							  ::PostMessageW(hWnd,WM_CHAR,(WPARAM)g_keystoadd[0],(LPARAM)1);
							 // wword[strlen(wword)] = (char)g_keystoadd[0];
                     g_keystoadd.erase(g_keystoadd.begin());
		  }
}
