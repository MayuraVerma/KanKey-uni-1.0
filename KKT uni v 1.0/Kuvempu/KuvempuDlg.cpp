...
BEGIN_MESSAGE_MAP(CKuvempuDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_STATIC_CLOSE,OnClose)
		ON_BN_CLICKED(IDC_STATIC_CLOSE_1,OnClose)
		
		ON_BN_CLICKED(IDC_STATIC_MINIMIZE,OnSetThisToTray)
...
void CKuvempuDlg::OnHemavathi() 
{
	...
	ResteButton();
			...
			hookID = 1;
			InstallKeyboardHookHemavathi(GetSafeHwnd());
...
void CKuvempuDlg::OnSharavathi() 
{
	...
	ResteButton();
			...
			InstallKeyboardHookSharavathi(GetSafeHwnd());
...
void CKuvempuDlg::OnNetravathi() 
{
	...
	ResteButton();
			...
			InstallKeyboardHookNetravathi(GetSafeHwnd());
...
void CKuvempuDlg::OnCauvery() 
{
	...
	ResteButton();
			...
			InstallKeyboardHookCauvery(GetSafeHwnd());
...
void CKuvempuDlg::OnTunga() 
{
	...
	ResteButton();
			...
			InstallKeyboardHookTunga(GetSafeHwnd());
...
void CKuvempuDlg::OnSetThisToTray()
{
	if(!isWinNTServer())
	{
		this->ShowWindow(SW_HIDE);
